...
export default function WhyBusBranding({
  cityName,
}: {
  cityName?: string;
}) {
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-20 items-center">
          ...
          <div className="lg:col-span-5 border-y border-white/10 py-12 flex flex-col justify-center">
            ...
            <p className="text-[11px] font-medium text-slate-400 font-sans tracking-wide mt-5 select-none">
              Full-stack advertising agency &bull; {cityName || "Bengaluru"} &bull; Since 2013
            </p>
          </div>

          {/* Right Column: Why BusBranding capabilities details */}
          <div className="lg:col-span-7 flex flex-col justify-center">
            {/* Eyebrow Tag */}
            <div className="flex items-center gap-2 mb-6">
              <span className="h-1.5 w-1.5 rounded-full bg-orange-500"></span>
              <span className="text-[10px] font-bold tracking-[0.18em] text-slate-400 uppercase font-sans">
                WHY RWA ACTIVATION BY IM SOLUTIONS
              </span>
            </div>
            ...
            <p className="text-sm sm:text-base text-slate-300 font-medium leading-relaxed font-sans mt-6 mb-10 max-w-xl">
              One team connects demographic research, RWA permissions, stall designs, print production, event logistics, promoter management, and detailed post-activation audits&mdash;so BTL strategy does not dissolve between multiple vendors.
            </p>
