...
export default function WhatIsBusAdvertising() {
  const [imageError, setImageError] = useState(false);

  const bulletPoints = [
    "Engage premium families in gated communities",
    "Build brand trust in a comfortable home environment",
    "Highly targeted reach by household income & lifestyle",
    "Interactive product trials and face-to-face feedback",
  ];
  ...
  const primaryImage = "https://images.unsplash.com/photo-1511578314322-379afb476865?q=80&w=1000&auto=format&fit=crop";
  const fallbackImage = "https://images.unsplash.com/photo-1511578314322-379afb476865?q=80&w=1000&auto=format&fit=crop";
        ...
        <div className="grid grid-cols-1 items-center gap-10 lg:grid-cols-12">
          ...
          <div className="lg:col-span-5 flex flex-col text-left">
            ...
            <h2 className="mt-3 text-3xl font-extrabold tracking-tight text-slate-900 sm:text-4xl leading-tight font-serif">
              Direct Connection. Trust-Based BTL.
            </h2>
            <p className="mt-6 text-base text-slate-600 leading-relaxed font-medium">
              RWA activation is one of the most powerful and cost-effective BTL marketing methods today. It allows brands to connect directly with consumers in a comfortable, trust-based environment — their own residential society.
            </p>
          ...
          <div className="lg:col-span-5 relative flex justify-center items-center">
            <div className="w-full overflow-hidden rounded-2xl border border-slate-100 shadow-lg hover:shadow-2xl transition-all duration-500 hover:scale-[1.01] group bg-slate-50">
              ...
              <img
                ...
                alt="RWA Canopy Activations and Events"
